...
var InfoCmd = &cobra.Command{
	Use:   "info",
	Short: "is a collection of subcommands to retrieve CPU, RAM, and DISK usage",
	Long:  `command provides a collection of subcommands to retrieve info of CPU, RAM, and DISK usage`,
